...
final class StaffBookingCreator
{
    ...
    {
        return DB::transaction(function () use ($request, $staff, $customer, $newCustomer) {
            if ($customer === null) {
            ...
            } elseif ($customer->assigned_staff_id === null) {
                try {
            ...
            return $this->creator->create($request, $customer, $staff)['booking'];
        });
    }
}
