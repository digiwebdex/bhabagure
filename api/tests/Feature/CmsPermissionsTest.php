...
class CmsPermissionsTest extends TestCase
{
    ...
    {
        //                         role              packages  pricing  posts  team  reviews  gallery  settings  media
        return [
            'super admin' => ['super_admin',   [200, 200, 200, 200, 200, 200, 200, 200]],
            'admin' => ['admin',               [200, 200, 200, 200, 200, 200, 200, 200]],
            'tour operator' => ['tour_operator', [200, 200, 403, 403, 403, 403, 403, 200]],
            'sales agent' => ['sales_agent',   [403, 403, 403, 403, 403, 403, 403, 403]],
            'accountant' => ['accountant',     [403, 403, 403, 403, 403, 403, 403, 403]],
        ];
    }
    ...
    public function each_role_reaches_exactly_the_cms_screens_it_should(string $role, array $expected): void
    {
        ...
        $paths = ['packages', 'pricing', 'posts', 'team', 'reviews', 'gallery', 'settings', 'media'];
