    ...
    <main className="flex min-h-dvh items-center justify-center bg-app-nav px-4 py-10">
      <div className="flex w-full max-w-modal-sm flex-col gap-6">
        <div className="flex items-end justify-between gap-4">
          ...
          <button type="button" onClick={() => void i18n.changeLanguage(locale === 'bn' ? 'en' : 'bn')} className="cursor-pointer rounded-10 border border-white/15 bg-transparent px-3 py-2 text-13 text-app-nav-text">
