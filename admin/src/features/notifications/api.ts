...
export type AlertEvent = 'new_booking_alert' | 'new_lead_alert' | 'low_seat_alert' | 'quote_accepted_alert' | 'support_ticket_alert'
export const ALERT_EVENTS: AlertEvent[] = ['new_booking_alert', 'new_lead_alert', 'low_seat_alert', 'quote_accepted_alert', 'support_ticket_alert']
